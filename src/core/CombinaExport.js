...
// ========== FUNCIÓN SPIN PARA MÓVIL (CON TAMAÑO CONSISTENTE Y PROPORCIONAL) ==========
function spinMobile() {
    ...
    // Calcular combinación aleatoria
    ...
    // TAMAÑO FIJO para todas las imágenes (consistentes)
    ...
    // Función para crear sprite con tamaño consistente (manteniendo proporción)
    function createConsistentSprite(texture) {
        const sprite = new PIXI.Sprite(texture);
        // Calcular escala para que el lado más grande sea FIXED_IMAGE_SIZE
    ...
    // Función para actualizar la textura de un sprite manteniendo el tamaño
    function updateSpriteTexture(sprite, newTexture) {
        const currentScale = sprite.scale.x;
        sprite.texture = newTexture;
        // Mantener la misma escala para que el tamaño no cambie
    ...
    function cleanupClone() {
        ...
        if (currentClone) {
            overlayLayer.removeChild(currentClone);
            currentClone = null;
        }
    }
    ...
    function processNextSlot() {
        ...
        // Crear sprites con TAMAÑO CONSISTENTE para el efecto de giro
                ...
                if (animProgress >= 1) {
                    ...
                    currentSpinInterval = setInterval(function() {
                        ...
                        for (let i = 0; i < rotatingSprites.length; i++) {
                            ...
                            // Si la imagen sale de la ventana por abajo, reposicionar arriba
                            ...
                            // Si sale por arriba, reposicionar abajo
    ...
    processNextSlot();
        ...
        // ========== FUNCIÓN SPIN PARA ESCRITORIO (ORIGINAL) ==========
...
console.log('CombinaBajas - ${this.config.combinaName}');`;
    ...
    generateReadme() {
        return `========================================
${this.config.combinaName.toUpperCase()} - COMBINABAJAS
========================================
